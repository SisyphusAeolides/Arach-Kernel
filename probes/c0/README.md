...
proves the first live userspace slice: `write`, `getpid`, `gettid`, `getppid`,
anonymous `mmap`, exact-range `munmap`, `brk`, and `exit_group`. The probe
writes `ARACH_C0_RING3_SYSCALL_PASS` after entering ring 3 and
