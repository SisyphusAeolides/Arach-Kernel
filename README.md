...
| System bootstrap | Granite, Arach Kernel, and Push assemble into a pinned, measured C0 bundle; CI now executes that bundle under QEMU/OVMF and preserves serial evidence | Keep the QEMU execution gate green for the exact release revision, then promote the result to a boot-qualified artifact |
