...
#[unsafe(no_mangle)]
extern "C" fn arach_interrupt_dispatch(frame: *mut InterruptFrame) -> usize {
    ...
    match frame.vector {
        ...
        2 | 8 | 18 => {
            ...
            let _ = writeln!(
                serial,
                "Arach contained {class}: vector={} error={:#x} rip={:#x}",
        ...
        3 => {
            if frame.code_segment & 3 == 3 {
                ...
                if crate::arch::x86_64::privilege::complete_user_probe() {
                    ...
                    let _ = writeln!(
                        serial,
                        "Arach: Ring 3 trap rip={user_instruction_pointer:#x} cs={user_code_segment:#x}, returning through RSP0",
                    );
                    return 1;
                } else {
                    halt();
        ...
        14 => {
            ...
            let _ = writeln!(
                serial,
                "Arach page fault: address={:#x} error={:#x} present={} write={} user={} execute={}",
                fault.address,
                fault.error_code,
        ...
        _ => {
            ...
            let _ = writeln!(
                serial,
                "Arach exception: vector={} error={:#x} rip={:#x}",
                frame.vector, frame.error_code, frame.instruction_pointer
            );
            halt();
        }
