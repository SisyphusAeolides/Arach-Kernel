...
core::arch::global_asm!(
    r#"
    .text
    .global arach_rtm_call_win64_context
    .type arach_rtm_call_win64_context,@function
arach_rtm_call_win64_context:
    pushq %r12
    pushq %r13
    pushq %r14
    pushq %r15
...
3:
    ...
    popq %r12
    ret
    .size arach_rtm_call_win64_context, .-arach_rtm_call_win64_context
"#,
    options(att_syntax)
);

unsafe extern "C" {
    fn arach_rtm_call_win64_context(
...
pub unsafe fn execute_time_capsule(
    ...
    unsafe {
        arach_rtm_call_win64_context(function, context, &mut result, &mut status);
    }
