...
pub struct QuantumArachPlatform<
    'a,
...
impl<
    ...
    Recovery: QuantumRecoveryBroker + ?Sized,
    const CHECKPOINTS: usize,
> QuantumArachPlatform<'a, Display, Recovery, CHECKPOINTS>
{
...
impl<
    ...
    Recovery: QuantumRecoveryBroker + ?Sized,
    const CHECKPOINTS: usize,
> QuantumCrestPlatform for QuantumArachPlatform<'_, Display, Recovery, CHECKPOINTS>
{
